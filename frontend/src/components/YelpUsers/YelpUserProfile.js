                                        ...
                                        br / > {
                                            ...
                                            br / > {
                                                ...
                                                br / > {
                                                    ...
                                                    br / >
                                                    <
                                                    h4 className = 'text-black' > Lives In: { ' ' } { yelpuser.city ? yelpuser.city : '' },
                                                    ...
                                                    br / > {
                                                        ...
                                                        br / > {
                                                            ...
                                                            <
                                                            Link to = '/yelpuserspage'
                                                            className = 'btn btn-dark' > Go Back YelpUsers < /Link> <
                                                            button className = 'btn btn-light'
                                                            onClick = {
                                                                (e) => onClick(e) }
                                                            value = { userId } > Follow < /button> <
                                                            br / >
                                                            <
                                                            /div> <
                                                            /div> <
